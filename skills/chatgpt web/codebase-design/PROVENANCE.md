# Provenance and adaptation: codebase-design
...
- Source folder: `skills/engineering/codebase-design/`
- Retrieved: **2026-09-11, America/Vancouver**
- Pinned source: https://github.com/mattpocock/skills/tree/3cca18b368ae95cdbdebbff572ccafa662551015/skills/engineering/codebase-design
...
- Make Design It Twice capability-aware: retain 3+ radically different designs, all four original design constraints, all five output requirements, the comparison axes, and the opinionated recommendation. Substitute labeled same-agent passes only when sub-agents are unavailable; independent exploration remains unverified.
- Treat project CONTEXT.md as repository evidence rather than a bundled file or assumed local checkout.
- Preserve DEEPENING.md byte-for-byte, including its strong replace-don't-layer testing guidance.
